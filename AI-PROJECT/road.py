...
class Road:
    ...
    def calcBorders(self, i):
        ...
        self.pointsLeft[i].y = center.y - y if not center.y - y >= self.pointsLeft[prev_index].y else self. \
            pointsLeft[prev_index].y
        self.pointsRight[i].x = center.x + x
        self.pointsRight[i].y = center.y + y if not center.y + y >= self.pointsRight[prev_index].y else self. \
            pointsRight[prev_index].y
